...
message = 'we love python programmming o o o '
...
newmessage = "#    we support hamas         #"
print(newmessage.strip("# ws"))
print(newmessage.lstrip("# sw"))
print(newmessage.rstrip('# sw'))

"""print char , index in the string """

message = 'information technology institute'  # char and its index
# for char in message:
#     print(f"char={char}, index = {message.index(char)}")
#
#
...
indexed_string= enumerate(message)
print(indexed_string)  # enumerate object
for i , char in indexed_string:
